  ...
  return (
    <div className='skills-container'>
      <Card className='development skills'>
        ...
        <div className='flex'>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain-wordmark.svg" alt='graphql icon' title='GraphQL'/>
          ...
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/webpack/webpack-original-wordmark.svg" alt='webpack logo' title='Webpack'/>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original-wordmark.svg" alt='express logo' title='Express'/> 
      ...
      <Card className='workflow skills'>
        ...
        <div className='flex'>
          ...
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/npm/npm-original-wordmark.svg" alt='npm logo' title='npm'/>
        </div>
      ...
      <Card className='testing skills'>
        ...
        <div className='flex'>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mocha/mocha-plain.svg" alt='mocha logo' title='Mocha'/>
          <img src='https://raw.githubusercontent.com/cypress-io/cypress/develop/assets/cypress-logo-light.png' alt='cypress logo' title='Cypress'/>
        </div>
      ...
      <Card className='web-design skills'>
        ...
        <div className='flex'>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original-wordmark.svg" alt='bootstrap logo' title='BootStrap'/>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original-wordmark.svg" alt='css logo' title='CSS3'/>
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original-wordmark.svg" alt='html logo' title='HTML5'/>   
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/trello/trello-plain.svg" alt='trello logo' title='Trello'/>
